...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GraphItem.related_location'
        db.add_column('lizard_graph_graphitem', 'related_location', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GraphItem.related_location'
        db.delete_column('lizard_graph_graphitem', 'related_location')
