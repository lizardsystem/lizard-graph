...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GraphItem.layout'
        db.delete_column('lizard_graph_graphitem', 'layout_id')

        # Adding field 'GraphItem.color'
        db.add_column('lizard_graph_graphitem', 'color', self.gf('lizard_map.models.ColorField')(default='', max_length=8, null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.color_outside'
        db.add_column('lizard_graph_graphitem', 'color_outside', self.gf('lizard_map.models.ColorField')(default='', max_length=8, null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.line_width'
        db.add_column('lizard_graph_graphitem', 'line_width', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.line_style'
        db.add_column('lizard_graph_graphitem', 'line_style', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.label'
        db.add_column('lizard_graph_graphitem', 'label', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GraphItem.layout'
        db.add_column('lizard_graph_graphitem', 'layout', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_graph.GraphLayout'], null=True, blank=True), keep_default=False)

        # Deleting field 'GraphItem.color'
        db.delete_column('lizard_graph_graphitem', 'color')

        # Deleting field 'GraphItem.color_outside'
        db.delete_column('lizard_graph_graphitem', 'color_outside')

        # Deleting field 'GraphItem.line_width'
        db.delete_column('lizard_graph_graphitem', 'line_width')

        # Deleting field 'GraphItem.line_style'
        db.delete_column('lizard_graph_graphitem', 'line_style')

        # Deleting field 'GraphItem.label'
        db.delete_column('lizard_graph_graphitem', 'label')
