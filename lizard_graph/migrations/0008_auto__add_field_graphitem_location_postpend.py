...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GraphItem.location_postpend'
        db.add_column('lizard_graph_graphitem', 'location_postpend', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GraphItem.location_postpend'
        db.delete_column('lizard_graph_graphitem', 'location_postpend')
