...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PredefinedGraph.legend_location'
        db.add_column('lizard_graph_predefinedgraph', 'legend_location', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PredefinedGraph.legend_location'
        db.delete_column('lizard_graph_predefinedgraph', 'legend_location')
