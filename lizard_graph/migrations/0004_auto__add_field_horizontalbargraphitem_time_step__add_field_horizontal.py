...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HorizontalBarGraphItem.time_step'
        db.add_column('lizard_graph_horizontalbargraphitem', 'time_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.TimeStepCache'], null=True, blank=True), keep_default=False)

        # Adding field 'HorizontalBarGraphItem.qualifierset'
        db.add_column('lizard_graph_horizontalbargraphitem', 'qualifierset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.QualifierSetCache'], null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.time_step'
        db.add_column('lizard_graph_graphitem', 'time_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.TimeStepCache'], null=True, blank=True), keep_default=False)

        # Adding field 'GraphItem.qualifierset'
        db.add_column('lizard_graph_graphitem', 'qualifierset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsnorm.QualifierSetCache'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HorizontalBarGraphItem.time_step'
        db.delete_column('lizard_graph_horizontalbargraphitem', 'time_step_id')

        # Deleting field 'HorizontalBarGraphItem.qualifierset'
        db.delete_column('lizard_graph_horizontalbargraphitem', 'qualifierset_id')

        # Deleting field 'GraphItem.time_step'
        db.delete_column('lizard_graph_graphitem', 'time_step_id')

        # Deleting field 'GraphItem.qualifierset'
        db.delete_column('lizard_graph_graphitem', 'qualifierset_id')
